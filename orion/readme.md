...
For a simple start, you can use the docker-compose-simple.yml file and start only the ORION context broker
...
For more information about the docker image, please check [telefonicaiot in Docker hub](https://hub.docker.com/r/telefonicaiot/fiware-orion)
